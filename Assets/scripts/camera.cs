...
public class camera : MonoBehaviour {
	...
	void Update ()
    {
        ...
        Vector3 vector = new Vector3(0, 3f, -5f); //nowa pozycja kamery
        ...
        transform.position = Vector3.Lerp(transform.position, newPosition,Time.deltaTime*2f); //nadaje płynność poruszania się kamery
